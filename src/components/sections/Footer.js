...
const Footer = () => (
  <footer className="z-10 fixed inset-x-0 left-1/2 flex h-[70px] w-[calc(100%_-_64px)] max-w-max -translate-x-1/2 -translate-y-1/2 justify-between rounded-[34px] border-2 border-slate-50 border-primary-200 bg-primary-100 text-sm shadow-primary backdrop-blur dark:border-primary-400 dark:border-opacity-20 dark:bg-mirage-900 dark:bg-opacity-[0.08] px-4 -mt-4">
