        ...
        <main className={utilStyles.headingMd}>
          ...
          <div className="grid grid-cols-2 max-w-5xl items-start">
            <div className="prose w-full text-left dark:prose-invert">
              <p className="">
                My name is <span class="font-bold">Nam</span>, nice to meet you! I’m 21 years old and am
                currently pursuing my Master's in Business Analytics at Santa
                Clara University. This summer, I will be interning at E. & J.
                Gallo Winery as an IT Systems Analyst. I'm passionate about the
                world of data analytics, as I enjoy transforming messy,
                unformatted data into valuable insights!
              </p>
              ...
              <ul className="list-disc list-inside indent-4">
                ...
                <li>
                  My younger brother Ha also attends SCU (sophomore)
                </li>
                <li>
                  "LuuPham" is a combination of our parents' last names
                </li>
                <li>
                ...
                <li>
                  Favorite anime: K-ON!, NGE, Ping Pong, Kaguya-sama
                </li>
